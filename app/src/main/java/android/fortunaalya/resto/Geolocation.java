...
public class Geolocation extends AppCompatActivity implements OnMapReadyCallback, PermissionsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mapbox.getInstance(this, "pk.eyJ1IjoidmVsbGlubXVkaXRhIiwiYSI6ImNraWQ4NDUyYzBwYnoyeW81MHZuNXJwM2YifQ.Bur295zzkC11HSZ-NETvAg");
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Geolocation.this, MenuActivity.class);
        ...
        searchfab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new PlaceAutocomplete.IntentBuilder()
                        .accessToken(Mapbox.getAccessToken() != null ? Mapbox.getAccessToken() :"pk.eyJ1IjoidmVsbGlubXVkaXRhIiwiYSI6ImNraWQ4NDUyYzBwYnoyeW81MHZuNXJwM2YifQ.Bur295zzkC11HSZ-NETvAg")
                        .placeOptions(PlaceOptions.builder()
                                .backgroundColor(Color.parseColor("#EEEEEE"))
                                .limit(10)
                                .build(PlaceOptions.MODE_CARDS))
                        .build(Geolocation.this);
...
//                    locationComponent.getLastKnownLocation().getLatitude());
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        ...
        mapboxMap.addMarker(new MarkerOptions().position(new LatLng(latitude, longitude)).title("PBP Resto"));
